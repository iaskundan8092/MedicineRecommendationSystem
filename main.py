from flask import Flask, request, render_template, jsonify, url_for  # Import jsonify
...
def predict():
    ...
    return render_template('predict.html', all_symptoms=list(symptoms_dict.keys()))
